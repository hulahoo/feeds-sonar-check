    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', intelhandler.models.CreationDateTimeField(auto_now_add=True, verbose_name='создано')),
                ('origin', models.CharField(max_length=128, verbose_name='источник')),
                ('type_of_feed', models.CharField(choices=[('MISP', 'MISP Feed'), ('MAIL', "Email's feed"), ('HASH', 'File hashes'), ('IPAD', 'IP adresses'), ('URLS', "Full URL's"), ('DOMN', "Domain's")], default='MAIL', max_length=4, verbose_name='Тип фида')),
                ...
                ('polling_frequency', models.CharField(choices=[('NVR', 'Никогда'), ('M30', '30 минут'), ('HR1', '1 час'), ('HR2', '2 часа'), ('HR4', '4 часа'), ('HR8', '8 часов'), ('H16', '16 часов'), ('H24', '24 часа')], default='NVR', max_length=3, verbose_name='Тип фида')),
